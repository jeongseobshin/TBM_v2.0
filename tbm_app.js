...
const TBM_DB = {
  ...
  material: [
    ["프레스 금형 잔류물로 인한 화상", "-작업 전 금형·잔류물 냉각 확인 -집게·전용공구로 제거 -내열장갑·보안경 착용"],
    ["물레 주변 바닥 습기로 인한 미끄러짐", "-작업 전후 물기 즉시 제거 -논슬립 매트·배수로 점검 -미끄럼방지 안전화 착용"],
    ["장시간 반복작업에 따른 근골격계 질환", "-작업 전 스트레칭 실시 -1시간마다 자세 전환·휴식 -작업대 높이 개인별 조정"],
    ["작업장 내 통로 협소로 인한 충돌 위험", "-통로 폭 확보·적치물 금지 -교차구간 서행·주의표지 -수시 정리정돈"],
    ["전기 콘센트 주변 먼지 누적으로 인한 감전", "-분전반·콘센트 정기 청소 -누전차단기 월 1회 동작시험 -피복 손상 전선 즉시 교체"],
    ["프레스 조작 중 손 끼임", "-양수조작·광전자식 방호장치 확인 -금형 사이 손 투입 금지 -이상 시 비상정지 후 보고"],
    ["물레 작업 중 회전부 옷 끼임", "-소매·옷자락·장갑 말림 방지 -회전 중 접근·청소 금지 -방호덮개 임의 해체 금지"],
    ["금형 교체 시 낙하물 위험", "-교체 전 금형 결속·받침대 고정 -2인1조 인양공구 사용 -하부 출입통제·안전화 착용"],
    ["소재 절단 시 칼날 이탈", "-작업 전 칼날 체결·마모 점검 -이탈방지 가이드·덮개 설치 -교체 시 전원 차단"],
    ["소재 투입 시 손 끼임", "-투입구 가드·밀대(푸시스틱) 사용 -가동 중 손 투입 금지 -정량 투입 준수"],
    ["소재 절단 시 비산물로 인한 눈 부상", "-보안경·안면보호구 착용 -소재 고정 후 절단 -비산 방지 커버 설치"],
    ["설비 유지보수 중 오작동으로 인한 협착", "-점검 전 전원 차단 및 LOTO 적용 -작동금지 표지 부착 -완료 후 주변 인원 확인"],
    ["프레스 주변 정리 미흡으로 인한 전도", "-작업 전후 공구·자재 정위치 -바닥 유압유 즉시 제거 -통로 적치물 금지"],
    ["공정 간 이송 중 들림 동작으로 인한 허리 통증", "-리프터·대차 사용 -5kg 이상 2인1조 -다리 힘으로 들고 허리 굽힘 금지"],
    ["물레 회전 시 소음 노출에 따른 청력 손상", "-귀마개·귀덮개 착용 -소음구역 표지 확인 -정기 소음측정·청력검사 참여"]
  ],
  packaging: [
    ["충진기 작동 중 손·팔 끼임", "-가동 중 손 접근 금지 -안전커버·비상정지 위치 확인 -정비 시 전원 차단"],
    ["자재 사이 이동 시 협소 공간 충돌", "-이동 경로·시야 확보 -진입 전 주변 확인 -교차구간 서행"],
    ["이동 중 다른 작업자와 충돌", "-지정 통로 이용 -이동 전 주변 확인·신호 -모퉁이 서행"],
    ["재포장 작업 중 포장지에 의한 베임", "-작업용 장갑 착용 -전용 커터 사용·날 방향 주의 -포장지 끝단 주의"],
    ["납품 수량 오류로 인한 재포장 작업 발생", "-충진량·수량 이중 확인 -자동 카운터 활용 -재작업 시 무리한 연속작업 금지"],
    ["무거운 자재 적재 시 높이 부족으로 인한 충격", "-적정 적재높이 준수 -충돌방지 패드 부착 -중량물 하단 적재"],
    ["충진기 센서 오작동으로 인한 과충진·불량", "-센서 주기 점검·청소 -초기 시험운전 실시 -예비 부품 비치"],
    ["포장 시 정전기 발생으로 인한 불쾌감·불량", "-정전기 방지복·접지 사용 -작업장 습도 관리 -제전기 설치"],
    ["기계 내부 청소 중 사고", "-세척 전 전원 차단 및 LOTO -회전부 정지 확인 -2인1조 작업"],
    ["포장 테이블 모서리 충돌로 인한 타박상", "-모서리 완충재 설치 -작업 동선 확보 -급한 이동 자제"],
    ["충진량 오류로 인한 내용물 누출·바닥 오염", "-충진센서·유량밸브 정기 점검 -바닥 누출물 즉시 제거 -미끄럼 주의표지"],
    ["무거운 상자 운반 시 요통", "-적정 무게로 분할 운반 -대차·컨베이어 사용 -2인1조 및 스트레칭"],
    ["바닥 박스 방치로 인한 걸림", "-통로 적치 금지 -작업 중 수시 정리 -빈 박스 즉시 반출"],
    ["파렛트 위 이동 중 낙상", "-파렛트 위 승상 금지 -작업발판·안전계단 사용 -출입금지 구역 설정"],
    ["충진기 노즐 막힘으로 인한 압력 이상·파손", "-노즐 정기 세척·필터 장착 -압력계 수시 확인 -이상 압력 시 즉시 정지"]
  ],
  scm: [
    ["지게차 후진 시 보행자 충돌", "-후진 시 경보·클락션 -유도자·감시자 배치 -보행자 통로 분리"],
    ["지게차 상하차 중 적재물 낙하", "-상하차 전 결속 확인 -평탄한 지반 확보 -포크 하부 통행 금지"],
    ["화물차량 후진 중 접촉사고", "-후방 감시자 배치 -후진경고음 확인 -사각지대 진입 금지"],
    ["지게차 운전 중 주의 산만", "-운전 중 휴대폰·대화 금지 -제한속도 준수 -교차로 일시정지"],
    ["팔레트 이동 중 부상", "-보호구 착용 -진로·시야 확보 -핸드파렛트 급조작 금지"],
    ["지게차 작업 시 사각지대 충돌", "-반사조끼 착용 -사각지대 감시자 배치 -교차구간 서행·경적"],
    ["화물차 적재 중 균형 무너짐", "-하중 분산·편하중 방지 -결속 장비 사용 -적재높이 제한 준수"],
    ["지게차 충전 중 전기 화재", "-충전 시 전원 차단 -충전구역 환기·청결 -과충전 방지·누전 점검"],
    ["파렛트 파손으로 인한 하중 낙하", "-사용 전 파렛트 상태 점검 -불량 파렛트 즉시 폐기 -적재하중 표시 준수"],
    ["작업 중 통신 부재로 긴급상황 대처 지연", "-무전기 휴대 -비상연락체계 확인 -이상 시 즉시 작업중지 보고"],
    ["지게차 작업장 내 보행자 출입 통제 미흡", "-작업구역 출입 제한·표지 -사전 안전교육 -통로 물리적 분리"],
    ["하역 작업 시 무거운 물품으로 인한 손목 부상", "-손목 보호대 착용 -작업 전 스트레칭 -중량물 대차 사용"],
    ["지게차 급정거로 인한 적재물 쏠림", "-무게중심 고려 적재 -감속·서행 운전 -결속 상태 확인"],
    ["작업 중 파렛트 모서리에 찔림", "-손 보호구 착용 -파렛트 상태 점검 -파손부 즉시 격리"],
    ["혼잡한 공간에서의 차량 경로 혼선", "-일방통행 경로 지정 -유도선·표지판 설치 -차량·보행 동선 분리"]
  ],
  quality: [
    ["불충분한 조명으로 인한 검수 누락", "-검수구역 조도 확보 -국부 조명 위치 조정 -정기 조도 점검"],
    ["장시간 검수로 인한 눈 피로", "-50분 검수 10분 휴식 -원거리 응시·눈 운동 -확대경·모니터 밝기 조정"],
    ["검수대 정리 미흡으로 인한 낙상", "-검수 후 즉시 정리정돈 -바닥 적치물 금지 -통로 확보"],
    ["검사 도구 부재로 인한 임시작업", "-작업 전 도구·게이지 점검 -표준 검사구 상시 비치 -교정일 확인"],
    ["검수 시 팔꿈치 압박 부상", "-작업대 팔 받침·쿠션 사용 -자세 전환·휴식 병행 -작업대 높이 조정"],
    ["불량 제품 혼입으로 인한 클레임", "-검사기준서 준수 -한도견본 대조 -이상 발견 시 즉시 격리·보고"],
    ["제품 라벨 식별 불량으로 인한 오검수", "-확대경·조명 각도 조정 -바코드 스캐너 병행 -표기 규격 사전 확인"],
    ["반복적인 손동작으로 인한 손목 통증", "-손목 보호대 착용 -중간 스트레칭 -작업 교대 실시"],
    ["정전기 발생으로 인한 제품 손상", "-정전기 방지패드·방지복 사용 -접지·제전기 사용 -작업장 습도 관리"],
    ["먼지·이물에 의한 검수 정확도 저하", "-청정 작업환경 유지 -공정 중 청소 주기화 -이물 관리구역 구분"],
    ["이동 중 검수물 낙하", "-전용 트레이 사용 -양손 운반·과적 금지 -이동 시 시야 확보"],
    ["검수물 고정 불량으로 인한 흔들림", "-제품별 맞춤 고정지그 사용 -고정 상태 확인 -작업대 수평 유지"],
    ["작업자 간 소통 부족으로 인한 혼선", "-작업 전 검사기준 공유 -인수인계 문서화 -이상 시 즉시 공유"],
    ["야간 검수 시 집중력 저하", "-교대제·적정 휴식 -야간 조도 강화 -중요검사 주간 배치"],
    ["검사 장비 미숙으로 인한 오판정", "-장비 사용법 정기 교육 -숙련도 평가·재교육 -표준 절차서 비치"]
  ],
  summer: [
    ["폭염에 의한 온열질환(열사병·열탈진)", "-그늘·냉방 휴게공간 확보 -폭염특보 시 옥외작업 중지 -규칙적 휴식(매시간)"],
    ["탈수·수분·염분 부족", "-시간당 물 1컵 이상 섭취 -이온음료·소금 비치 -갈증 전 미리 수분 보충"],
    ["고온다습 환경에 의한 집중력 저하", "-무더위 시간대(14~17시) 작업 조정 -충분한 휴식 -2인1조 상호 확인"],
    ["밀폐·고온 공간 열 축적에 의한 실신", "-강제환기·냉방 실시 -단독작업 금지 -감시인 배치"],
    ["이동식 냉방기 과열·화재", "-필터 정기 청소 -문어발 배선 금지 -자리 이석 시 전원 차단"],
    ["직사광선·자외선 노출", "-통풍 작업복·차양모 착용 -자외선 차단제 사용 -그늘막 설치"],
    ["고온에 의한 유증기·가스 발생 증가", "-환기 강화 -가스농도 수시 측정 -화기작업 주의"],
    ["습기에 의한 감전 위험 증가", "-누전차단기 점검 -젖은 손 전기작업 금지 -배선 방수 상태 확인"],
    ["음식물 부패에 의한 식중독", "-도시락·식수 위생관리 -냉장 보관 철저 -손 씻기 생활화"],
    ["땀에 의한 미끄러짐·보호구 이탈", "-미끄럼방지 신발 착용 -땀 흡수 보호구 사용 -바닥 물기 제거"],
    ["전기·소방설비 과부하 정전", "-부하 분산 -설비 온도 점검 -비상조명·발전기 상태 확인"],
    ["열피로 누적에 의한 오조작", "-2인1조 작업 -상호 컨디션 확인 -이상 시 즉시 휴식"],
    ["야외 이동·상하차 중 온열질환", "-작업 전후 수분 보충 -무리한 연속작업 금지 -그늘에서 휴식"]
  ],
  winter: [
    ["한랭에 의한 저체온증·동상", "-방한복·방한장갑 착용 -온열 휴게실 운영 -규칙적 실내 휴식"],
    ["바닥 결빙·적설에 의한 미끄러짐·전도", "-제설·제빙 실시 -미끄럼방지 신발·매트 사용 -주의표지 설치"],
    ["결로·성에에 의한 통로 미끄럼", "-통로 물기 제거 -주의 표지 설치 -환기로 결로 억제"],
    ["난방기·히터에 의한 화재", "-가연물 이격 -자리 이석 시 전원 차단 -소화기 비치"],
    ["밀폐공간 난방 시 일산화탄소 중독·질식", "-주기적 환기 -CO 경보기 설치 -연소식 난방기 사용 주의"],
    ["저온에 의한 근육 경직·염좌", "-작업 전 충분한 준비운동 -보온 유지 -중량물 작업 주의"],
    ["배관·설비 동파에 의한 누수·파손", "-보온재 점검 -동파 방지 열선 확인 -취약부 순회 점검"],
    ["손 시림에 의한 공구 놓침·협착", "-방한장갑 착용 -손 보온 -공구 낙하방지끈 사용"],
    ["건조에 의한 정전기 인화·감전", "-가습 실시 -접지·본딩 -정전기 방지복 착용"],
    ["결빙 고소작업 추락", "-발판 결빙 제거 -안전대 체결 -강풍·결빙 시 작업 중지"],
    ["노면 결빙에 의한 차량·지게차 미끄러짐", "-서행 운행 -스노체인·제설 -급제동·급회전 금지"],
    ["방한복 말림에 의한 회전체 협착", "-소매·옷자락 정리 -회전기계 접근 주의 -방호덮개 확인"],
    ["한랭·건조에 의한 호흡기 질환", "-마스크 착용 -실내 습도 관리 -온수 섭취"]
  ]
};
  ...
  <div class="gate-card login">
    ...
    <div class="login-form">
      ...
      <div class="field"><label>비밀번호</label>
        <div class="pw-wrap"><input type="password" id="loginPw" autocomplete="current-password" placeholder="비밀번호">
          <button type="button" class="pw-eye" data-act="togglePw" aria-label="비밀번호 표시" title="비밀번호 표시">👁</button></div></div>
    ...
    <div class="bd">
      ...
      <div class="clist">
        ${filtered.length? filtered.map(x=>`
          ...
          </div>`).join("") : `<div class="empty">${q?`<div class="ic">🔎</div><div class="big">검색 결과가 없습니다</div>‘${esc(q)}’와 일치하는 콘텐츠가 없습니다.`:`<div class="ic">📝</div><div class="big">아직 등록된 콘텐츠가 없습니다</div>위 <b>＋ 직접 입력</b>으로 이 부서의 교육콘텐츠를 추가하세요. 추가하는 즉시 자동생성에 반영됩니다.`}</div>`}
      </div>
    </div>
  </div>`;
}
...
document.addEventListener("click", e=>{
  ...
  if(act==="togglePw"){ const inp=$("#loginPw"); if(inp){ const hidden=inp.type==="password"; inp.type=hidden?"text":"password"; b.textContent=hidden?"🙈":"👁"; b.title=hidden?"비밀번호 숨기기":"비밀번호 표시"; try{inp.focus();}catch(_){} } return; }
  ...
  if(act==="regGen"){
    if(state.reg.edited && state.reg.items && state.reg.items.length){
      openModal("교육내용 전체 재생성", `<p class="mb-note">직접 수정한 내용이 있습니다. <b>전체 재생성</b>하면 지금 입력·수정한 위험요인과 대책이 모두 새 내용으로 바뀝니다. 계속할까요?</p>
        <div class="btn-row" style="margin-top:14px"><button class="btn primary" data-act="regGenConfirm">전체 재생성</button><button class="btn" data-act="closeModal">취소</button></div>`);
      return;
    }
    regRegenAll(); return;
  }
  ...
  if(act==="regDelete"){ const ex=DB.recordFor(state.account.id,state.reg.date); if(ex){ DB.delRecord(ex.id); state.reg.items=null; ensureRegItems(); toast("등록을 취소했습니다."); renderView(); } else { toast("취소할 등록 내역이 없습니다."); } return; }
  if(act==="regPrint"){
...
document.addEventListener("input", e=>{
  const t=e.target, f=t.dataset.f;
  if(t.dataset.ri!=null){ const i=+t.dataset.ri,k=t.dataset.rk; if(state.reg.items&&state.reg.items[i]){ state.reg.items[i][k]=t.value; state.reg.edited=true; } return; }
